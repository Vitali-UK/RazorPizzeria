...
namespace RazorPizzeria.Pages
{
    public class PizzaModel : PageModel
    {
        public List<PizzasModel> fakePizzaDB = new List<PizzasModel>()
        {
            ...
            new PizzasModel (){ImageTitle ="Bolognese", PizzaName="Bolognese", BasePrice=3,TomatoSauce=true, Cheese=true, FinalPrice=4},
            ...
            new PizzasModel (){ImageTitle ="MeatFeast", PizzaName="MeatFeast", BasePrice=5,TomatoSauce=true, Cheese=true, FinalPrice=7},
